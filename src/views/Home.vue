...
<style lang="scss" scoped>
  ...
  .swing div:nth-of-type(1) {
    background: -webkit-linear-gradient(left, #0f4c75 0%, #325774 100%);
    background: linear-gradient(to right, #0f4c75 0%, #325774 100%);
  }
  ...
  .swing div:nth-of-type(7) {
    background: -webkit-linear-gradient(left, #da3b26 0%, #ffb99a 100%);
    background: linear-gradient(to right, #da3b26 0%, #ffb99a 100%);
  }
  .shadow {
    clear: left;
    padding-top: 1.5em;
